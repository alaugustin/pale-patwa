...
const uiClasses = {
  ...
  wordListContainerClasses: `${flexItemsCenter} flex-col flex-1 border-t border-gray-100 w-full`,
  ...
  headerContainerClasses: `${flexItemsCenter} border-b border-gray-200 py-3 p-2 basis-14 justify-between`,
  dictionarySearchClasses: `${flexItemsCenter} flex-row rounded border border-gray-200 mb-8`,
